...
namespace DataLockActorProxyService
{
    ...
    /// </summary>
    internal sealed class DataLockActorProxyService : StatefulService
    {
        private StatefulEndpointCommunicationListener listener;
        public DataLockActorProxyService(StatefulServiceContext context)
            : base(context)
        { }
